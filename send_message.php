                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="d-none d-sm-block ms-2">
                            <h4 class="page-title">Send Message To Student</h4>
                        </div>
                    </div>
                        ...
                        <div class="card shadow-lg ">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm">
                                        <div class="form-group mb-2">
                                            ...
                                            <select  name="cstmr_ac" id="cstmr_ac" class="form-select select2"  onchange="currentStudentAc()">
                                                <option>Select</option>
                                                <?php 

                                                if ($cstmr=$con->query("SELECT * FROM student WHERE status=1 ")) {
                                ...
                                <div class="row">
                                    ...
                                    if ($allData=$con->query("SELECT * FROM message_template  ")) {
...
<!-- end main content-->
        ...
        <script src="assets/js/app.js"></script>
          <script type="text/javascript">
           ...
           function currentStudentAc(){
            var name=$("#cstmr_ac").val();
            var currentCstmrAc="0";
                $.ajax({
                    type:'POST',
                    data:{name:name,currentCstmrAc:currentCstmrAc},
                    url:'include/message.php',
                    success:function(response){
                        console.log(response);
                        $("#phone").val(response);
