                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="d-none d-sm-block ms-2">
                            <h4 class="page-title">Teacher Draft</h4>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-confirm">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-center">
                    ...
                    <button type="button" class="btn btn-success" id="deleteConfirmBtn">Restore</button>
                </div>
            </div>
        </div>
    </div>
...
<!-- end main content-->
        ...
        $(document).ready(function(){
            DraftallTeacher()
            function DraftallTeacher(){
                 var DraftallTeacher="0";
               $.ajax({
                     url:'include/teacher.php',
                    type:'POST',
                    data:{DraftallTeacher:DraftallTeacher},
                    success:function(response){
                         $("#teacher_table").html(response);
                        $("#loaderDiv").addClass('d-none');
                        $("#teacherDataTable").dataTable(deleteProcess());
                    }
               });
            }
        //delete  Script
        ...
        $("#deleteConfirmBtn").click(function() {
         ...
         function deleteData(deleteId) {
            ...
            $.ajax({
                type:'POST',
                data:{id:deleteId,teacherActive:deleteData},
                url:'include/teacher.php',
                success:function(response){
                    if (response==1) {
                        toastr.success("Active Successfull");
                             setTimeout(()=>{
                                location.reload();
                            },1000);
