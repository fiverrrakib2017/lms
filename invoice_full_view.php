        ...
        <div class="container-fluid">
           <div class="row">
               <div class="col-md-6  m-auto">
                ...
                <!-- <div class="card d-none" id="mainDiv">
                    ...
                    <div class="card-body">
                       ...
                       <div class="row">
                           ...
                           <div class="col-sm mb-1">
                               <?php 
                               if ($allStd=$con->query("SELECT * FROM invoice WHERE sid=$id ")) {
                                   while ($rows=$allStd->fetch_array()) {
                                       echo $rows["add_money"] ;
                ...
                <table class="table table-bordered" id="mainDiv">
                                         ...
                                         <tbody>
                                            ...
                                            $ALLinv=$con->query("SELECT * FROM invoice WHERE sid=$id ");
                                             ...
                                             <tr>
                                                 ...
                                                 <th class="text-left" colspan="3">
                                                     Total Amount <strong id="totalAmount">
                                                         ...
                                                         if ($all=$con->query("SELECT SUM(add_money) as totalAddMoney FROM invoice WHERE sid=$id")) {
